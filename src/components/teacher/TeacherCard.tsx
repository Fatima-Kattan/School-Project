...
interface TeacherCardProps {
    teacher: Teacher | TeacherWithDetails;
    onDelete: () => void;
    onEdit: () => void;
...
export default function TeacherCard({
    ...
    return (
        <>
            ...
            {isExpanded && (
                <tr className="bg-[#f0fdf4] border-t border-gray-100">
                                    ...
                                    {!classesData || (Array.isArray(classesData) && classesData.length === 0) ? (
                                        ...
                                        <div className="space-y-3 pr-6">
                                            {Array.isArray(classesData) && classesData.map((cls: any) => {
                                                ...
                                                // ✅ المواد موجودة داخل cls.subjects
                                                ...
                                                return (
                                                    <div key={classId} className="bg-white rounded-lg p-1.5 border border-gray-200">
                                                        <div className="flex items-center gap-2 mb-2">
                                                            ...
                                                            {/* ✅ عرض المواد مباشرة من cls.subjects */}
                                                            <div className="pr-1 flex flex-wrap gap-2">
                                                                {Array.isArray(classSubjects) && classSubjects.length > 0 ? (
                                                                    classSubjects.map((subject: any, idx: number) => {
                                                                        const subjectName = subject.name || subject.subject_name || subject;
                                                                        return (
                                                                            <span 
                                                                                key={idx} 
