// components/student/student form/StudentForm.tsx
    ...
    useEffect(() => {
        if (mode === 'edit' && initialData) {
            setFormData({
                ...
                section_id: initialData.section?.id || 0,
                parent_id: initialData.parent?.id || 0,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (mode === 'create') {
                ...
                await updateStudent(initialData.id, formData, token);
            }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="flex justify-end gap-3 pt-2">
                ...
                >
                    {mode === 'create' ? 'تأكيد إضافة الطالب' : 'تحديث البيانات'}
                </Button>
            </div>
